...
1. Making test **bold** and *italic*

## Important programming concept

- `print()` is a buil-in Python library
...
- [Markdown Guide](https://mude.citg.tudelft.nl/workbook-2026/assignments/PA1.2/1_markdown.html)
...
|JaveScript|Beginner|Web Development|⭐⭐⭐⭐⭐|
